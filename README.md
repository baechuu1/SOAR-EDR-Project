...
##### 2. Successfully deployed cloud window server using Vultr
...
##### 3. Linking the clous instance to LimaCharlie for detection
...
##### 6.Creating rules to detect LaZagne and with informations to alert the SOC analyst
...
##### 7.Create play book to automate the process of sending alerts to slack and email
...
##### 9.Messages is sent to Slack with the description of the alert
...
##### 10.Email is sent with the same description to the SOC analyst
